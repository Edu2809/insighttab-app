...
GEMINI_COOLDOWN_SECONDS = 5  # 1 chamada a cada 5s
...
if "last_gemini_call" not in st.session_state:
    st.session_state.last_gemini_call = 0.0
...
st.markdown(
    ...
    div[data-testid="stForm"] button[kind="formSubmit"], button[kind="formSubmit"], .stFormSubmitButton button, .stFormSubmitButton > button, div[data-testid="stForm"] > div > div > button {
    ...
    div[data-testid="stForm"] button[kind="formSubmit"]:hover, button[kind="formSubmit"]:hover, .stFormSubmitButton button:hover, .stFormSubmitButton > button:hover, div[data-testid="stForm"] > div > div > button:hover {
    ...
    div[data-testid="stForm"] button[kind="formSubmit"] *, button[kind="formSubmit"] *, .stFormSubmitButton button *, .stFormSubmitButton button p, div[data-testid="stForm"] button p {
        color: white !important;
    }
    ...
    * {
    ...
    .texto-branco, .texto-branco svg, .texto-branco path {
        color: white !important;
        fill: white !important;
        stroke: white !important;
    }
...
def can_call_gemini():
    now = time.time()
    elapsed = now - st.session_state.last_gemini_call
    return elapsed >= GEMINI_COOLDOWN_SECONDS, elapsed

def mark_gemini_call():
